...
<head>
  ...
  <link rel="stylesheet" href="sign.css">  <!-- Latest compiled and minified CSS -->
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link" href="/contact_us/contact.html"><img src="ImageBase/phone.png"></a>
            </li>
  ...
  <!-- <div class="content"> -->
    ...
    <div class="p-2 bd-highlight" id="box1">
        <form class="sign" action="sign.php" method="post">
            ...
            <input type="text" placeholder="Enter Email" name="email" required width="10px" >
      
            <label for="psw"><b>Password</b></label>
            <input type="password" placeholder="Enter Password " name="password"  id="psw"required>
      
            <label for="psw-confirm" id="cp"><b>Confirm Password</b></label>
            <input type="password" placeholder="Confirm Password " name="cpassword"  id="cpsw" onkeyup="check();" required>
            ...
            <p>By creating an account you agree to our <a href="#" style="color:dodgerblue">Terms & Privacy</a>.</p>
              ...
              <button type="submit" class="signupbtn" name="submit" id=btn>Sign Up</button>
...
<!--  
    ...
    letcp=document.getElementById("cp");
   function check()
   {
      if(psw==cpsw){
