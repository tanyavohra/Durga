...
<head>
  ...
  <link rel="stylesheet" href="kota.css" <!-- Latest compiled and minified CSS -->
...
<body>
  ...
  <!-- COMMENT AND IMAGE1 -->
   ...
   <div class="middle-part">
      <div class="image"><img class="jaipur_image" src="ImageBase/kota1.jpeg"></div>
   ...
   <!-- MORE PLACES -->
    <div class="images">
      <div class="image1"><div class="name1">City Mall</div></div>
      <div class="image2"> <div class="name2">Riverfront </div></div>
      <div class="image3"><div class="name3">Dad Devi Kota</div></div>
    </div>
