...
<head>
  ...
  <link rel="stylesheet" href="delhi.css"> <!-- Latest compiled and minified CSS -->
...
<body>
  ...
  <!-- COMMENT AND IMAGE1 -->
   ...
   <div class="middle-part">
      <div class="image"><img class="jaipur_image" src="ImageBase/palika delhi.jpeg"></div>
   ...
   <!-- MORE PLACES -->
    <div class="images">
      <div class="image1"><div class="name1">Connaught Place</div></div>
      <div class="image2"> <div class="name2">Rajiv Chawk</div></div>
      <div class="image3"><div class="name3">Sarojini Market</div></div>
    </div>
